...
function computerTurn(event) {
  ...
  console.log(buttonNodes[randomIndex]);
  // event.target.removeEventListener("click", testFunc);
  // function testFunc() {
  //   console.log("computer clicked this");
  // }
  // function handleClick(event) {
  //   console.log("handling click");
  //   event.preventDefault();
  // }
  // buttonNodes[randomIndex].addEventListener("click", handleClick);
